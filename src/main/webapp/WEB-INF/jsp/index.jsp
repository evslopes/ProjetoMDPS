...
<head>
    ...
    <title>Home - Mãe da Prole System</title>
    <!-- Favicon-->
...
<c:if test="${empty user}">
    ...
    <section class="page-section banner" id="banner">
        <div class="container">
            <!-- Portfolio Section Heading-->
            <h3 class="page-section-heading text-center text-uppercase text-secondary mb-0">Nossa comunidade</h3>
            <!-- Icon Divider-->
            ...
            <div class="row gx-16 gx-lg-16 justify-content text-center">
